...
<>
    ...
    <div className="relative">
        ...
        <div className=" ">
            <div className="container-wrapper">
                <div className=" rounded overflow-hidden">
                    <img className="w-full h-[420px] object-cover"
        ...
        {/* <img  className=" opacity-10 absolute top-0 -z-10 w-full h-full" src="https://images.unsplash.com/photo-1579818276653-bc3240840cf6?q=80&w=1480&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" /> */}
    </div>
</>
)
}