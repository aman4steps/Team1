            ...
            <div className="overflow-hidden">
                ...
                <div className="flex gap-5">
                    <div className={`transition-transform duration-300 ease-in-out ${isOrderListVisible ? 'block' : 'hidden'}  `}>
                        ...
                        <div className='border-2 border-slate-300 h-[65vh] overflow-hidden overflow-y-auto rounded-lg shadow-md px-2'>
                            <div className='p-2'>
                    ...
                    <div className='flex-1  md:min-w-[320px] max-w-full'>
                        <div className=''>
                            ...
                            <div className=' overflow-hidden overflow-x-scroll bg-white border-l-2 border-teal-700 text-black rounded-lg shadow-md p-4'>
                                {selectedOrder && (
                                    <div>
                                        ...
                                        <div className='flex items-center flex-wrap justify-center gap-5'>
                                            <div className='p-4 min-w-36'>
                                                <img className='w-52 rounded-md' src="https://cdn1.iconfinder.com/data/icons/avatar-2-2/512/Employee-512.png" alt="" />
                                            </div>
