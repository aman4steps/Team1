...
export default async (req: NextApiRequest, res: NextApiResponse) => {
    ...
    try {
        ...
        switch (req.method) {
            case 'PUT':
                const { name, price, status, location } = req.body;
            ...
            default:
                ...
                const inclusionDetails = await Inclusion.findOne({ package: updatedPackage._id }); //inclusion code is here
                ...
                updatedPackage._doc.prices = priceDetails;
