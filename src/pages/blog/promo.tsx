                ...
                <div className="grid grid-cols-1 lg:grid-cols-[2fr,1fr]">
                    <div>
                        <div className=" py-5 rounded flex flex-col md:flex-row md:items-center gap-5">
                            <div>
                                <img className="w-[500px] h-[180px] object-cover rounded-xl shadow-md" src="https://buffer.com/cdn-cgi/image/w=1000,fit=contain,q=90,f=auto/library/content/images/size/w600/2023/10/free-images.jpg" alt="" />
                            </div>
                            <div className="px-3">
                        ...
                        <div className=" py-5 rounded flex flex-col md:flex-row md:items-center gap-5">
                            <div>
                                <img className="w-[500px] h-[180px] object-cover rounded-xl shadow-md" src="https://images.unsplash.com/photo-1468818438311-4bab781ab9b8?q=80&w=1471&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
                            </div>
                            <div className="px-3">
                                <p className="font-semibold text-2xl pb-3">Lorem ipsum dolor sit.</p>
                                <div className=" line-clamp-2">
