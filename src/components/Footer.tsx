...
<>
    <div>
        ...
        <div className="bg-navyblack text-white">
                ...
                <footer className="  ">
                    ...
                    <div className="container-wrapper">
                        <p className="text-[12px]">*Caution: Beware of Fake Promotions or Offers *Please do not believe or
                            ...
                            or
                            responsibility whatsoever for any communication which is fraudulent or misleading in nature and
                            not
