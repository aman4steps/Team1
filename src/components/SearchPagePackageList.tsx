...
const fetchPackages = async (locationId: any) => {
    const response = await fetch(`/api/public/tour-packages?locationId=${locationId}`, { method: 'GET' });
...
const SearchPagePackageList = (locationId) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const packagesData = await fetchPackages(locationId.locationId, currentPage, itemsPerPage);
            ...
            {currentItems?.map((packageData) => (
                <div className=" relative py-5  mb-5 w-full md:flex md:h-[220px] gap-5 justify-between rounded-xl bg-white bg-clip-border text-gray-700 shadow-sm overflow-hidden">
                    <div className="md:pl-5 flex items-center">
                        <img className=" min-h-[200px] h-[280px] mx-5  md:m-0 w-full md:p-0 md:w-[440px] md:h-full rounded-md overflow-hidden object-cover"
                    ...
                    <div className="mx-6 md:m-0 mt-2">
                        <div className="">
                            ...
                            <div className=" line-clamp-3">
                                <p dangerouslySetInnerHTML={{ __html: packageData.about }} className="block text-[12px] font-normal text-gray-800">
                                </p>

                            </div>
                        </div>
                        <div className="flex gap-3 md:gap-4 justify-between md:justify-normal max-w-[350px] mt-3 mb-1">
                            <div className="flex flex-col items-center ">
                                <img className="w-4 " src="https://www.svgrepo.com/show/13776/building.svg" alt="" />
                                <p className="text-[10px] text-neutral-600">Hotel</p>
                            </div>

                            <div className="flex flex-col items-center ">
                                <img className="w-4 " src="https://www.svgrepo.com/show/6379/french-fries-on-container.svg"
                                    alt="" />
                                <p className="text-[10px] text-neutral-600">Meals</p>
                            </div>

                            <div className="flex flex-col items-center ">
                                <img className="w-4 " src="https://www.svgrepo.com/show/447874/transport.svg" alt="" />
                                <p className="text-[10px] text-neutral-600">Transport</p>
                            </div>

                            <div className="flex flex-col items-center ">
                                <img className="w-4 " src="https://www.svgrepo.com/show/438545/flight.svg" alt="" />
                                <p className="text-[10px] text-neutral-600">Flight</p>
                            </div>

                            <div className="flex flex-col items-center ">
                                <img className="w-4 " src="https://www.svgrepo.com/show/533057/camera-alt-1.svg" alt="" />
                                <p className="text-[10px] text-neutral-600">Sightseeing</p>
                            </div>

                            <div className="flex flex-col items-center ">
                                <img className="w-4 " src="https://www.svgrepo.com/show/394547/visa.svg" alt="" />
                    ...
                    <div className=" md:w-[420px] m-auto md:m-0 md:border-l justify-center px-5 flex flex-col">
                        ...
                        <div className="flex flex-cols">
                            <Link href={'/package/' + packageData.pageUrl}
