...
<div>
        ...
        <div className=" container-wrapper  h-16 z-30 top-5  flex  items-center justify-between">
            ...
            <div className="flex items-center justify-between gap-10">
                ...
                <div className="flex items-center gap-5 z-30">
                    <p>+44 54 554 54552</p>
                    <button className="border rounded-md  px-5 py-1 bg-gradient-to-tl from-primary to-yellow-500 text-white">Sign in</button>
                </div>
            </div>
        </div>
    ...
    <div className="relative h-[100vh] flex items-center justify-center">
        ...
        <div className="z-20 text-white text-center relative">
            <h1 className="text-[32px] font-bold">Lorem ipsum dolor. Explicabo, quam!</h1>
