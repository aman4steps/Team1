...
const SearchPageTopSeoContent = ({ state }) => {
    return (
            <div className="mb-10">
                <div>
                    <img className="w-full h-80 object-cover" src="https://images.unsplash.com/photo-1503220317375-aaad61436b1b?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
                </div>
                <div className="container-wrapper py-5">
                    <p className="text-lg mb-2">{state?.name}</p>
                    <p className="text-para line-clamp-3">{state?.description}</p>
