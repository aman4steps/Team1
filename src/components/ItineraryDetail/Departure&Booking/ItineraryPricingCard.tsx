            ...
            <div className=" border p-3 rounded-md bg-white xs:mt-5 xl:mt-0 xs:hidden xl:block overflow-hidden " >
                <div className="bg-white">
                    <div className="flex justify-between">
                        ...
                        <div>
                            <Addguest getData={getData} pricingPackage={pricingPackage}>
                ...
                <div className=" overflow-y-auto">
                    ...
                    <div className="flex mb-[10px] text-sm">
                        ...
                        <p className=" font-semibold text-graytext">Adults:{isData.adult},  Child:{isData.child},  Infant:{isData.infant}</p>
                    </div>
                    <div className="flex mb-[10px] text-sm">
                        <p className=" w-20">Rooms :</p>
                        <div className="">

                            {Object.keys(isData).map((roomType, index) => (
                                isData[roomType] > 0 && roomType !== "adult" && roomType !== "child" && roomType !== "infant" &&
                                <p key={index} className="font-semibold capitalize">{roomType}: {isData[roomType]}</p>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className='grid grid-cols-2 gap-3'>
                        ...
                        <Addguest getData={getData}>
                            <button className="bg-primary w-full text-white flex justify-center py-2 rounded-md">Book now</button>
                        </Addguest>
                    </div>
