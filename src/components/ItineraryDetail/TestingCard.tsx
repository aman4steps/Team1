    ...
    return (
        <div className="carousel-container relative container-wrapper">
            <div className="carousel gap-5" ref={carouselRef}>
                {/* start is here code  */}
                <div className="relative flex-shrink-0 w-80  flex-col rounded-md bg-white bg-clip-border text-gray-700 shadow-md border">
                    <div
                        ...
                        <img className=' h-40 w-full object-cover' src="https://images.unsplash.com/photo-1499696010180-025ef6e1a8f9?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=1470&amp;q=80"
                    ...
                    <div className="px-6 pt-1 pb-3 mb-1">
                        <button className="text-white bg-primary w-full py-2 rounded-md font-semibold text-base " type="button">
                            View details
                        </button>
                    </div>
                </div>
