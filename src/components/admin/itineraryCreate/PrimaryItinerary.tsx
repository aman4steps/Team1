...
export default function ({ setActiveTab, itinerary, itineraryInfo, setItineraryInfo }) {
    ...
    // choose image in flight booking
        ...
        <>
            <div className="bg-white p-4 rounded-md">
                <div className=" grid grid-cols-1 md:grid-cols-2 mb-4 gap-5">
                    {/* basic information and input field */}
                    <div className="border p-4 rounded">
                        ...
                        <div className=" border-b-2 pb-4">
                            <div className="">
                                <div>
                                    <label htmlFor="cityBages" className="pb-2 font-semibold text-para">City Bages :</label>
                                    <MultipleSelectChip packageBadges={packageBadges} />
                                </div>
