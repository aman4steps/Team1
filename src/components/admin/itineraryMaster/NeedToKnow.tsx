...
const NeedToKnowComponent = () => {
    ...
    const handleDelete = async () => {
        if (deleteGroupId) {
            try {
                const response = await fetch('/api/package/tour-info/need-to-know/delete', {
                    method: 'POST',
    ...
    const handleEdit = (id) => {
        ...
        setNeedToKnowGroup({ groupName: group.groupName, description: group.description });
    ...
    const handleSave = async () => {
        const url = isEditing
            ? '/api/package/tour-info/need-to-know/edit'
            : '/api/package/tour-info/need-to-know/add';
            ...
            <div className="md:flex gap-5">
                ...
                <div className=" grow border rounded p-4 h-72">
                    <div className='flex flex-col'>
                        <label className="pb-2 font-semibold">Tour NeedToKnow</label>
                        ...
                        {/* Display the currently selected group name */}
                            ...
                            <div className='w-full  h-[225px]'>
                                <QuillNoSSRWrapper
                                    ...
                                    onChange={(html) => setNeedToKnowGroup({ ...NeedToKnowGroup, description: html })}
                                    modules={modules}
                                />
                            </div>
                        </div>
...
export default NeedToKnowComponent;
