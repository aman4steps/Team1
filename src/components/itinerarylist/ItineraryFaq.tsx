  ...
  return (
    <div className="w-full md:w-3/4 m-auto ">
      <div className="text-center mb-10">
        <p className=" text-2xl mb-2 ">HighLight & Inclusion</p>
      ...
      <Accordion className="my-2 shadow-none border-y-[1px] bg-[#F1F5F9] outline-0 ">
        ...
        >
          ...
          {/* <Itineraryfaqheading/>  */}
          <p className="text-para ">Expanded by default Lorem, ipsum door</p>
        </AccordionSummary>
      ...
      <Accordion className="my-2 shadow-none border-y-[1px] bg-[#F1F5F9] outline-0 ">
        ...
        >
          {/* itenaray heading is here */}
          {/* <Itineraryfaqheading/>  */}
          <p className="text-para ">Expanded by default Lorem, ipsum dolor.</p>
        </AccordionSummary>
